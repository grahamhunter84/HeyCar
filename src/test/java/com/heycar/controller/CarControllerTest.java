...
public class CarControllerTest {
  ...
  public void setup() {
    ...
    repository.save(new CarListing("Toyota", "Sport", 1234, "red", new BigDecimal(1000), 2019));
    repository.save(new CarListing("Toyota", "Corolla", 1234, "red", new BigDecimal(1000), 2000));
  ...
  public void testSearchByMake() throws Exception {
    mockMvc.perform(get("/search?make=Toyota"))
        .andExpect(status().isOk())
        .andExpect(jsonPath("content.[0].make").value("Toyota"))
        .andExpect(jsonPath("content.[0].model").value("Sport"))
        .andExpect(jsonPath("content.[0].kW").value("1234"))
  ...
  public void testSearchByModel() throws Exception {
    mockMvc.perform(get("/search?model=Corolla"))
        .andExpect(status().isOk())
        .andExpect(jsonPath("content.[0].make").value("Toyota"))
